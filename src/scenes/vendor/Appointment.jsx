...
import { MenuItem, Select, FormControl, InputLabel, Checkbox, FormGroup, FormControlLabel, CircularProgress } from '@mui/material';
                ...
                >
                  <CardContent sx={{ pb: 7 }}>
                    <Box display="flex" alignItems="center" mb={2}>
                      ...
                      <Box>
                        <Typography variant="h6" color={theme.palette.mode === 'dark' ? colors.gray[100] : '#222'} fontWeight="bold" sx={{ fontFamily: 'Poppins, sans-serif' }}>
                    ...
                    <Box mb={1} display="flex" alignItems="center">
                      ...
                      <Typography variant="body2" color={colors.gray[200]} mr={2} sx={{ fontFamily: 'Poppins, sans-serif' }}>
                        {new Date(appointment.date).toLocaleDateString()}
                      </Typography>
                      <AccessTimeIcon sx={{ fontSize: 18, mr: 1, color: colors.greenAccent[400] }} />
                      <Typography variant="body2" color={colors.gray[200]} sx={{ fontFamily: 'Poppins, sans-serif' }}>
                    ...
                    {appointment.notes && (
                      <Box mt={1} display="flex" alignItems="center">
                        ...
                        <Typography variant="body2" color={colors.gray[300]} sx={{ fontFamily: 'Poppins, sans-serif' }}>
                          {appointment.notes}
                        </Typography>
                      </Box>
                    )}
